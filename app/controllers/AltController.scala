...
import models.akka.DownstreamActor
...
@Singleton
class AltController @Inject() (implicit settings: Settings, actorSystem: ActorSystem,
  ...
  private val downstream = actorSystem.actorOf(DownstreamActor.props(settings), settings.Nodes.Downstream)
