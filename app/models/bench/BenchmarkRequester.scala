 ...
 */
class BenchmarkRequester(linkName: String, proxy: CommProxy, eventDaos: EventDaos, config: BenchmarkRequesterConfig)
...
object BenchmarkRequester {
   ...
   */
  def props(linkName: String, proxy: CommProxy, eventDaos: EventDaos, config: BenchmarkRequesterConfig) =
    Props(new BenchmarkRequester(linkName, proxy, eventDaos, config))
