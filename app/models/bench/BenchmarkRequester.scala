...
object BenchmarkRequester {
   ...
   */
  def props(linkName: String, routee: Routee, eventDaos: EventDaos, config: BenchmarkRequesterConfig) =
    Props(new BenchmarkRequester(linkName, routee, eventDaos, config))
