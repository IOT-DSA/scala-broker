...
object MgmtCommand {
  ...
  final case class GetState(replyTo: ActorRef[GetStateResponse]) extends CmdR[GetStateResponse]
  ...
  final case class AddChild(replyTo: ActorRef[AddChildResponse]) extends CmdR[AddChildResponse]
